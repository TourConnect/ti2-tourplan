...
// const getRatesObjectArray = (OptStayResults, markupPercentage = 0, OptStayResultsExtendedDates = []) => {
//   console.log('OptStayResults', OptStayResults);
//   console.log('markupPercentage', markupPercentage);
//   console.log('OptStayResultsExtendedDates', OptStayResultsExtendedDates);
