...
describe('tp-helpers/system-settings', () => {
  ...
  it('skips Undefined and Unassigned country names', () => {
    ...
    expect(toDestinationCountryMap([{
      ...
      DestinationNames: {
        DestinationName: ['Example City', 'Example Resort'],
      },
    }])).toEqual({});
  });

  it('strips provider-specific numeric prefixes from CountryName', () => {
